...
mkdir zoo_data
echo "2" > /Softwares/zoo_data/myid
...
# Add custom zookeeper and kafka configuration
 ...
 cp -rf /tmp/zookeeper2.properties /Softwares/kafka_2.11-2.4.1/config/
 cp -rf /tmp/server2.properties /Softwares/kafka_2.11-2.4.1/config/
