...
## Kafka Manager
- nano kafka-manager-docker-compose.yml, copy cotent into this from [here](https://github.com/MetaArivu/Kafka-quickstart/blob/main/08-cluster-setup/kafka-manager-docker-compose.yml)
